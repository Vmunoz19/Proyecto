...
class Rol(models.Model):
    ...
    sueldo = models.DecimalField(max_digits=10, decimal_places=2, editable=False)  
    ...
    def save(self, *args, **kwargs):
        # Asignación automática del sueldo
        self.sueldo = self.empleado.sueldo
        
        # Cálculos automáticos
        self.iess = self.sueldo * Decimal('0.0945')
        self.tot_ing = self.sueldo + (self.horas_extra or 0) + (self.bono or 0)
